        ...
        <div class="container d-flex justify-content-md-start">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mt-4 mt-md-0 gap-md-4">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo $basePath; ?>about" class="nav-link fw-medium" style="color: #2e384d;">About</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo $basePath; ?>blogs" class="nav-link fw-medium" style="color: #2e384d;">Blogs</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo $basePath; ?>contact" class="nav-link fw-medium" style="color: #2e384d;">Contact us</a>
                    </li>
                </ul>
                ...
                <div class="d-flex auth mt-2 mt-md-0">
                    <?php if (isset($_SESSION['user_id'])) { ?>
                        <a href="<?php echo $basePath; ?>user/profile" class="text-decoration-none fw-medium" style="color: #607f61;">
                    ...
                    <?php } else { ?>
                        <a href="<?php echo $basePath; ?>register" class="text-decoration-none fw-medium" style="color: #607f61;">Sign up</a>
                        <span class="fw-lighter mx-3" style="color: #2e384d;">|</span>
                        <a href="<?php echo $basePath; ?>login" class="text-decoration-none fw-medium" style="color: #607f61;">Log in</a>
                    <?php } ?>
                </div>
            </div>
        </div>
