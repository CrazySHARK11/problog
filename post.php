    ...
    <div class="container">
        <div class="row justify-content-center align-items-center vh-100">
            <div class="col-12 gap-2 text-center d-flex flex-column justify-content-center align-items-center">
                <img src="./assets/img/pagegone.svg" width="300" class="mb-5" alt="">
                <h2 class="fw-semibold fs-1">Page Is Gone</h2>
                <p style="max-width: 500px; color: gray;" class="fw-normal lead">
                    The page you are looking for might have been gone or is no longer available. Please check the URL or return to the homepage.
                </p>
